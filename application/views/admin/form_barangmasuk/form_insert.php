...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-mini"><b>M</b>GD</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Manajemen</b>Gudang</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url('admin/tabel_satuan')?>"><i class="fa fa-circle-o"></i> Tabel Satuan Barang</a></li>
          </ul>
        </li>
        <li>
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" readonly="readonly" value="SHS-<?=date("Y");?><?=random_string('numeric', 8);?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  ...
                  <select class="form-control" name="gudang" style="margin-left:75px;width:20%;display:inline;">
                ...
                <div class="form-group" style="display:inline-block;">
                  <label for="kode_barang" style="width:73%;">Satuan</label>
                  <select class="form-control" name="kode_barang" style="width:110%;margin-right: 18px;"class="form-control" id="kode_barang">
                    <option value="">-- Pilih --</option>
                  ...
                  <div class="form-group" style="display:inline-block;">
                  <label for="pengirim" style="width:87%;margin-left: 12px;">Nama Pengirim</label>
                  <input type="text" name="pengirim" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="pengirim" placeholder="Nama Pengirim">
                </div>
              <div class="form-group" style="display:inline-block;">
