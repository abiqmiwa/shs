          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <?php } ?>
              ...
              <div class="form-group" style="display:inline-block;">
                  ...
                  <input class="form-control" name="kode_barang" readonly="readonly" style="width:110%;margin-right: 18px;"class="form-control" id="kode_barang" value="<?=$d->kode_barang?>">
                    
              </div>
              <div class="form-group" style="display:inline-block;">
                  <label for="penerima" style="width:87%;margin-left: 12px;">Nama Penerima</label>
                  <input type="text" name="penerima" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="penerima" placeholder="Nama Penerima">
                </div>
